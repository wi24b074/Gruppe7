Feature: Preise verwalten
  Als Administrator möchte ich AC- und DC-Preise pro Standort verwalten können,
  ...
  Scenario: Preise für AC/DC-Ladevorgänge pro Standort festlegen
    ...
    When der Administrator setzt den AC-Preis auf 0.35 und den DC-Preis auf 0.55 für Standort "LOC-1"
  ...
  Scenario: Bestehende Preise ändern
    ...
    When der Administrator ändert den AC-Preis auf 0.30 und den DC-Preis auf 0.50 für Standort "LOC-1"
